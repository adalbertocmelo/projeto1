...
public class relFechamentoFinanceiroMami extends HttpServlet {
	/**
	 * 
	 */
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            String relJasper = path + barra + "relFechamentoFinanceiroMapaMidia.jasper";
            ...
            parameters.put("SQLSIDO", request.getParameter("sqlsido"));
            parameters.put("LSTSIDONOME", request.getParameter("lstsidonome"));
            parameters.put("SQLFINANCEIROABERTO", request.getParameter("sqlfinanceiroaberto"));
            parameters.put("SQLNAOFATURADO", request.getParameter("sqlnaofaturado"));
            parameters.put("PECAID", request.getParameter("pecaid"));
            parameters.put("ATIVID", request.getParameter("ativid"));
            parameters.put("PESSIDVEIC", request.getParameter("pessidveic"));
