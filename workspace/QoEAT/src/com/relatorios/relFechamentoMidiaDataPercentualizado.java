...
public class relFechamentoMidiaDataPercentualizado extends HttpServlet {
	/**
	 * 
	 */
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            String relJasper = path + barra + "relFechamentoMidiaDataPercentualizado.jasper";
            //String subrelDir = path + barra;
            
            Map parameters = new HashMap();
		
            parameters.put("PERIODO", request.getParameter("periodo"));
            parameters.put("SITUACAO", request.getParameter("situacao"));
