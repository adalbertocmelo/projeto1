...
public class relHonorarios extends HttpServlet {
	/**
	 * 
	 */
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            String relJasper = path + barra + "relHonorarios.jasper";
            ...
            parameters.put("SQLDATAORDEM", request.getParameter("sqldataordem"));
