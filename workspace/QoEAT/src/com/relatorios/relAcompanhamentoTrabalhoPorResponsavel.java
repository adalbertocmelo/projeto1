...
public class relAcompanhamentoTrabalhoPorResponsavel extends HttpServlet {
	/**
	 * 
	 */
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            String relJasper = path + barra + "relAcompanhamentoTrabalhoPorResponsavel.jasper";
            //String subrelDir = path + barra;
            
            Map parameters = new HashMap();
		
            parameters.put("USUAID", request.getParameter("usuaid"));
