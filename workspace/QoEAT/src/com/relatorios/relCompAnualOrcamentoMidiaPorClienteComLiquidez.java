...
public class relCompAnualOrcamentoMidiaPorClienteComLiquidez extends HttpServlet {
	/**
	 * 
	 */
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            String relJasper = path + barra + "relCompAnualOrcamentoMidiaPorClienteComLiquidez.jasper";
