...
public class relRelacaoOs extends HttpServlet {
	/**
	 * 
	 */
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            String relJasper = path + barra + "relRelacaoOs.jasper";
            ...
            String filtro = db.filtroSql(request.getParameter("pista") , lista.arrExplode(':',"sql1.numero: sql1.cliente: sql1.titulo: sql1.peca: sql1.briefing: sql1.situabreviatura: sql1.ativnome"));
