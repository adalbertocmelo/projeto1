...
public class relResumidoInvestimentoMidiaPraca extends HttpServlet {
	/**
	 * 
	 */
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            String relJasper = path + barra + "relResumidoInvestimentoMidiaPraca.jasper";
            ...
            parameters.put("CIDAID", request.getParameter("cidaid"));
