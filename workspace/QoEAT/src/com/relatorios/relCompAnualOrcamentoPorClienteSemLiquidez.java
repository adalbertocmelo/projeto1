...
public class relCompAnualOrcamentoPorClienteSemLiquidez extends HttpServlet {
	/**
	 * 
	 */
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            String relJasper = path + barra + "relCompAnualOrcamentoPorClienteSemLiquidez.jasper";
