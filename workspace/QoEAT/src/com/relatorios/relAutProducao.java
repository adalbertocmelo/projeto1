...
public class relAutProducao extends HttpServlet {
	/**
	 * 
	 */
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            String relJasper = path + barra + "relAutorizacaoProducao.jasper";
            //String subrelDir = path + barra;
            
            Map parameters = new HashMap();
		
            parameters.put("DOCUID", request.getParameter("docuid"));
            parameters.put("EMPRID", request.getParameter("emprid"));            
            parameters.put("SUBREPORT_DIR", path + barra);
            if (request.getParameter("logo").charAt(0) == '1')
            {
            	parameters.put("LOGO", pathimg + barra + "logoCAIntranet.gif");
            	parameters.put("IMGCNPJ", pathimg + barra + "cacnpj.jpg");
            }
            else
            {
            	parameters.put("LOGO", "");
            	parameters.put("IMGCNPJ", "");
            }
