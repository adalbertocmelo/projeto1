...
public class relFinanceiroOrdemNumero extends HttpServlet {
	/**
	 * 
	 */
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            String relJasper = path + barra + "relFinanceiroOrdemNumero.jasper";
            ...
            parameters.put("TPRELTITULO", request.getParameter("tpreltitulo"));
            parameters.put("SQLDATA1", request.getParameter("sqldata1"));
            ...
            parameters.put("SELECTDATA", request.getParameter("selectdata"));
