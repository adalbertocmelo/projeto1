...
public class relRanqAnualOrcaMidia extends HttpServlet {
	/**
	 * 
	 */
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            String relJasper = path + barra + "relRanqAnualOrcaMidia.jasper";
            //String subrelDir = path + barra;
            
            Map parameters = new HashMap();
		
            parameters.put("PERIODO", request.getParameter("periodo"));
            parameters.put("ANOREFERENCIA", request.getParameter("anoreferencia"));
