...
public class relOrdemServico extends HttpServlet {
	/**
	 * 
	 */
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            String relJasper = path + barra + "relOrdemServico.jasper";
            ...
            String filtro = db.filtroSql(request.getParameter("pista") , lista.arrExplode(':',"sql2.numero: sql2.clienome: sql2.titulo: sql2.peca: sql2.briefing: sql2.situabreviatura: sql2.ativo"));
