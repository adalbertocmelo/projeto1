...
public class relCompAnualOrcamentoMidiaPorClienteSemLiquidez extends HttpServlet {
	/**
	 * 
	 */
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            String relJasper = path + barra + "relCompAnualOrcamentoMidiaPorClienteSemLiquidez.jasper";
