...
public class relFinanceiroMidiaRecNaoRec extends HttpServlet {
	/**
	 * 
	 */
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            String relJasper = path + barra + "relFinanceiroMidiaRecNaoRec.jasper";
            ...
            parameters.put("DATAINICIO", request.getParameter("datainicio"));
            parameters.put("DATATERMINO", request.getParameter("datatermino"));
