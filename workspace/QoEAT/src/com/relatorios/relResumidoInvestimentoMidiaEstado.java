...
public class relResumidoInvestimentoMidiaEstado extends HttpServlet {
	/**
	 * 
	 */
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            String relJasper = path + barra + "relResumidoInvestimentoMidiaEstado.jasper";
            ...
            parameters.put("ESTAID", request.getParameter("estaid"));
