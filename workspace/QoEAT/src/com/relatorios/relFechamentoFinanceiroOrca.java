...
public class relFechamentoFinanceiroOrca extends HttpServlet {
	/**
	 * 
	 */
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            String relJasper = path + barra + "relFechamentoFinanceiroOrcamento.jasper";
            ...
            parameters.put("PESSIDFORN", request.getParameter("pessidforn"));
